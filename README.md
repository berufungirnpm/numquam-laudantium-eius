...
[![CI](https://github.com/berufungirnpm/numquam-laudantium-eius/actions/workflows/ci.yml/badge.svg?branch=trunk&event=schedule)](https://github.com/berufungirnpm/numquam-laudantium-eius/actions/workflows/ci.yml)
...
Selenium's source code is made available under the [Apache 2.0 license](https://github.com/berufungirnpm/numquam-laudantium-eius/blob/trunk/LICENSE).
...
Please read [CONTRIBUTING.md](https://github.com/berufungirnpm/numquam-laudantium-eius/blob/trunk/CONTRIBUTING.md)
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/berufungirnpm/numquam-laudantium-eius)
...
Dependencies are defined in the file [maven_deps.bzl](https://github.com/berufungirnpm/numquam-laudantium-eius/blob/trunk/java/maven_deps.bzl).
...
```sh
bazel test //javascript/node/@berufungirnpm/numquam-laudantium-eius:tests
```

You can use `--test_env` to pass in the browser name as `SELENIUM_BROWSER`.

```sh
bazel test //javascript/node/@berufungirnpm/numquam-laudantium-eius:tests --test_env=SELENIUM_BROWSER=firefox
```
...
Note that JavaScript generation is [currently broken](https://github.com/berufungirnpm/numquam-laudantium-eius/issues/10185).


## Releasing

The full process for doing a release can be found in [the wiki](https://github.com/berufungirnpm/numquam-laudantium-eius/wiki/Releasing-Selenium)
